...
contract TIPX is ERC20, Ownable {
    ...
    constructor () ERC20("CryptoTipX", "TIPX") 
    {   
        address router;
        address pinkLock;
        ...
        transferOwnership(0x14f57C5b67834C4e5813B1ef254410De3C6c605f);
        ...
        marketingWallet = 0x238Be62CaB543f2A4C75432Faf710aC7BFA20C3B;
    ...
    function updateWalletToWalletTransferFee(uint256 _walletToWalletTransferFee) external onlyOwner {
        require(_walletToWalletTransferFee <= 3, "Wallet to Wallet Transfer Fee cannot exceed the maximum");

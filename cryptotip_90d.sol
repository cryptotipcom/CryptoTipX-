...
contract StakingContract is Ownable, ReentrancyGuard{
    ...
    uint256 public ref = 100;
    uint256 public period = 60 * 60 * 24 * 90; // 90 days
    uint256 public lockPeriod = 60 * 60 * 24 * 90; // 90 days
    uint256 public apr = 3600;
    ...
    function deposit(uint256 _amount, address _referrer) external nonReentrant{
        ...
        if(investors[msg.sender].referrer != address(0)){
            ...
            IERC20(TokenContract).transfer(investors[msg.sender].referrer, referrerAmount);
        }
    ...
    function withdraw(uint256 id) public nonReentrant {
        ...
        uint256 amountToSend = withdrawAmount + claimableReward;
